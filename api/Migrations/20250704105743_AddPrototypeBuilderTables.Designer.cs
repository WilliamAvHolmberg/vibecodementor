...
namespace api.Migrations
{
    ...
    [Migration("20250704105743_AddPrototypeBuilderTables")]
    partial class AddPrototypeBuilderTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Features.PrototypeBuilder.Models.GeneratedPrototype", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_GeneratedPrototypes_CreatedAt");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("IX_GeneratedPrototypes_SessionId");

                    b.HasIndex("SessionId", "CreatedAt")
                        .HasDatabaseName("IX_GeneratedPrototypes_SessionId_CreatedAt");

                    b.ToTable("GeneratedPrototypes");
                });

            modelBuilder.Entity("Api.Features.PrototypeBuilder.Models.PrototypeMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_PrototypeMessages_CreatedAt");

                    b.HasIndex("SessionId")
                        .HasDatabaseName("IX_PrototypeMessages_SessionId");

                    b.HasIndex("SessionId", "CreatedAt")
                        .HasDatabaseName("IX_PrototypeMessages_SessionId_CreatedAt");

                    b.ToTable("PrototypeMessages");
                });

            modelBuilder.Entity("Api.Features.PrototypeBuilder.Models.PrototypeSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CreatedAt")
                        .HasDatabaseName("IX_PrototypeSessions_CreatedAt");

                    b.ToTable("PrototypeSessions");
                });
            ...
            modelBuilder.Entity("Api.Features.PrototypeBuilder.Models.GeneratedPrototype", b =>
                {
                    b.HasOne("Api.Features.PrototypeBuilder.Models.PrototypeSession", "Session")
                        .WithMany("GeneratedPrototypes")
            ...
            modelBuilder.Entity("Api.Features.PrototypeBuilder.Models.PrototypeSession", b =>
                {
                    b.Navigation("GeneratedPrototypes");
