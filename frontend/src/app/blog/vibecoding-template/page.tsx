        ...
        <section className="pb-20 px-3 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <article className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                While most vibecoders seem to go with the typical Vercel + Supabase combo, I decided to take a different route. I've been self-hosting a .NET backend with SQLite on a <strong>$5 DigitalOcean droplet</strong>, and honestly? It's worked amazingly well. There's something really satisfying about going back to the "primitives" and understanding how everything fits together.
              </p>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                <strong>Repository:</strong> <a href="https://github.com/WilliamAvHolmberg/vibecodementor" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">https://github.com/WilliamAvHolmberg/rapid-dev</a>
              </p>
              ...
              <div className="mt-12 text-center border-t border-gray-200 dark:border-gray-700 pt-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a 
                    href="https://github.com/WilliamAvHolmberg/rapid-dev" 
                    target="_blank" 
